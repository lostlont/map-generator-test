...
class Map:
	...
	def generate(self):
		...
		self.temperature_layer = Layer(self.width, self.height, scale = 16 * self.scale, octaves = 3)
		self.temperature_layer.generate()
		self.humidity_layer = Layer(self.width, self.height, scale = 8 * self.scale, octaves = 3)
